...
- [x] Implementar CRUD completo:
  ...
  - [x] Update (updateUser)
  - [x] Delete (deleteUser)
- [x] Criar tela UsersPage com formulário
- [x] Alternar entre botões Adicionar e Salvar Alterações
- [x] Criar rotina de edição com `editingId`
- [x] Fallback de armazenamento para Web (modo memória)
...
- [ ] Melhorar o design dos inputs e botões
